...
```{r appendixA,out.width = "478px", out.height = "470px", fig.align="left"}

      if(knitr:::is_latex_output())
      img <-  paste(basepath,'figures/AppendixSurveyHistory.png',sep="")
...
# DATA FORMS 2020 SABLEFISH SURVEY. {#app:third-appendix}

```{r appendixC,out.width = "480px", out.height = "406px", fig.align="left"}

      if(knitr:::is_latex_output())
      img <-  paste(basepath,'figures/AppendixC_BridgeLogIns3.png',sep="")
      knitr::include_graphics(img) 
...
```{r appendixC2,out.width = "500px", out.height = "452px", fig.align="left"}

      if(knitr:::is_latex_output())
      img <-  paste(basepath,'figures/AppendixC_SetLogIns.png',sep="")
      knitr::include_graphics(img) 
...
```{r appendixC3,out.width = "500px", out.height = "476px", fig.align="left"}

      if(knitr:::is_latex_output())
      img <-  paste(basepath,'figures/AppendixC_CatchLogIns.png',sep='')
      knitr::include_graphics(img) 
...
```{r appendixC4,out.width = "500px", out.height = "426px", fig.align="left"}

      if(knitr:::is_latex_output())
      img <-  paste(basepath,'figures/AppendixC_CatchLogTabIns.png',sep="")
      knitr::include_graphics(img) 
...
```{r appendixC5,out.width = "480px", out.height = "588px", fig.align="left"}

      if(knitr:::is_latex_output())
      img <-  paste(basepath,'figures/AppendixC_LSWMOIns.png',sep="")
      knitr::include_graphics(img) 
...
```{r appendixC6,out.width = "500px", out.height = "501px", fig.align="left"}

      if(knitr:::is_latex_output())
      img <-  paste(basepath,'figures/AppendixC_TaggingSheetIns.png',sep="")
      knitr::include_graphics(img) 
