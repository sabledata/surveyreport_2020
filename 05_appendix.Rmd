...
```
Figure B.4.  Example of a tabular catch log data entry form transposed from the catch log in Figure C.3. Directions from the 2020 survey instruction manual. 
