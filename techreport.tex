...
\caption{\label{tab:table2}Summary of sablefish biological data collected during the 2020 stratified random sets by spatial and depth stratum.}
...
\caption{\label{tab:table3}Summary of sablefish biological data collected during the 2020 stratified random sets by spatial and depth stratum.}
...
\caption{\label{tab:table4}Percentage of sablefish tag recoveries by great circle distance (km) from BC release sites (1995-2018) and years at liberty.}
\fontsize{10}{12}\selectfont
\begin{tabular}[t]{lllllll}
\toprule
\multicolumn{1}{c}{\textbf{ }} & \multicolumn{5}{c}{\textbf{Great Circle Distance (km) from Release Location}} & \multicolumn{1}{c}{\textbf{ }} \\
\cmidrule(l{3pt}r{3pt}){2-6}
\textbf{\textbf{Years at Liberty}} & \textbf{\textbf{>10}} & \textbf{\textbf{11-50}} & \textbf{\textbf{51-100}} & \textbf{\textbf{101-500}} & \textbf{\textbf{>500}} & \textbf{\textbf{Recovery Count}}\\
\midrule
1 & 45.6 & 44.7 & 43.6 & 33.4 & 22 & 24241\\
2-5 & 42.2 & 42.4 & 43.6 & 53.6 & 54.5 & 29987\\
6-10 & 9.4 & 9.7 & 10 & 10.5 & 17.7 & 6805\\
11+ & 2.8 & 3.2 & 2.8 & 2.5 & 5.8 & 1958\\
\hline
Total Count & 16780 & 12219 & 5566 & 21451 & 6975 & 62991\\
\bottomrule
\end{tabular}
\end{table}
\clearpage
