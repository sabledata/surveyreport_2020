...
The 2020 survey was 46 days long and divided into two legs of 16 and 29 days, with a day between in Port Hardy. Several weeks of inclement weather contributed to a longer second leg. In total, 27 fishing days were recorded.
...
Length, sex, maturity, otoliths and DNA samples were collected for 126 rougheye/blackspotted rockfish samples. The science samplers visually identifed 68 as rougheye, 58 as blackspotted and none as hybrid species (Appendix~\ref{app:sixth-appendix}).
...
Co-plots of average temperatures and average depths by 1-degree latitude intervals from south-west Vancouver Island to northwest Haida Gwaii indicate that the 2020 survey data exhibited a general trend of decreasing temperature with depth over latitude. The coldest average temperature per set recorded was 2.6 \(^\circ\)C with an average depth of 1295 m in the latitude zone of 52\(^\circ\) - 53\(^\circ\) (Figure~\ref{fig:figure15}).
