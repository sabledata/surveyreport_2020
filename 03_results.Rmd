...
Co-plots of average temperatures and average depths by 1-degree latitude intervals from south-west Vancouver Island to northwest Haida Gwaii can be found in Figure \@ref(fig:figure19).  The `r yr` survey data exhibit a general trend of decreasing temperature with depth. 
