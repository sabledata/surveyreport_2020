...
identifed `r re.count` as rougheye, `r bs.count` as blackspotted and `r hy.count` as hybrid species (Appendix \@ref(app:sixth-appendix)).
...
Co-plots of average temperatures and average depths by 1-degree latitude intervals from south-west Vancouver Island to northwest Haida Gwaii indicate that the `r yr` survey data exhibited a general trend of decreasing temperature with depth over latitude.  The coldest average temperature per set recorded was `r coldest` $^\circ$C with an average depth of `r deepcold$depth` m in the latitude zone of  `r deepcold$lat`$^\circ$ - `r deepcold$lat +1`$^\circ$ (Figure \@ref(fig:figure15)).
