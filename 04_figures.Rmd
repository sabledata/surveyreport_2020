...
```{r figure8, fig.cap='(ref:figure8)', results='asis', out.width = "450px",out.height = "560px", fig.align="center"}
  ...
  png("C:/github/surveyreport/figures/Figure8.png", width=600, height=800) # write png to file
  library(cowplot)
...
```{r , fig.cap='(ref:figure19)', results='asis', out.width = "400px",out.height = "666px", fig.align = "center"}
figure19      # table SEABIRD_ReportLinePlot created in the Sablefish.dbo.Build_Seabird_tables procedure
    
       png(paste(basepath,'figures/figure19.png',sep=''), width=600, height=1000) # write png to file
       ctddt  <-  "select * from SEABIRD_ReportLinePlot"
       ctd    <-  GetSQLData(ctddt,"Sablefish")   # read from SQL Server
       write.table(ctd, file = paste(path,"figure18.csv",sep=''),row.names=FALSE, na="",col.names=TRUE,  sep=",") 
       ctd    <-  read.csv(paste(path,'figure18.csv',sep=''),header=T)  # read from csv
