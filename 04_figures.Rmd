...
```{r figure setup, include=FALSE}
        ...
        write.table(LWSMOdat, file = paste(path,"figure.csv",sep=''),row.names=FALSE, na="",col.names=TRUE, sep=",")
...
```{r figure14, fig.cap='(ref:figure14)',results='asis', out.width = "450px",out.height = "276px", fig.align="center"}
     ...
     png(paste(basepath,'figures/figure14.png',sep=''), width = 700, height = 430) # -- starts writing a png to figure folder
...
(ref:figure19) Vertical density ridgeplots of mean temperatures per year as reported by set from the Sea-bird SBE 39 loggers at three depth intervals, RD~1~ = shallow (100-450 m), RD~2~ = mid (450-850 m), RD~3~ = deep (850-1400 m). Lines indicate the 2.5% and 97.5% tails.
...
```{r figure19, fig.cap='(ref:figure19)', results='asis', out.width = "480px",out.height = "616px", fig.align = "center"}
      ...
      ggplot(weather.raw2, aes(x = Avgtemp, y = years, fill=`Depth Stratum`, alpha = 0.4)) +
           ...
           geom_density_ridges(
                ...
                alpha = .9, point_alpha = .2, jittered_points = TRUE
                ) +
