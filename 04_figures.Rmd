...
```{r figure2, fig.cap='(ref:figure2)', echo=FALSE, out.width = "500px", out.height = "397px", fig.align="left", warning=FALSE}
...
```{r figure14, fig.cap='(ref:figure14)',results='asis', out.width = "450px", out.height = "264px", fig.align="center"}
    ...
    png("C:/github/surveyreport2020/figures/figure14.png", width = 700, height = 412) # -- starts writing a png to figure folder
...
```{r figure16, fig.cap='(ref:figure16)',results='asis', out.width = "480px", out.height = "419px", fig.align="center"}
   png(paste(basepath,'figures/figure16.png',sep=''), width = 600, height = 524)  # starts writing a png to figure folder

   tagPlotdata  <-  " select  dbo.q_Fish_Tag_Release_Simple.rel_year, ISNULL(dbo.q_Fish_Tag_Recovery_Simple.rec_year, 0) AS rec_year, 
                      COUNT(dbo.q_Fish_Tag_Release_Simple.TAG_ID) AS count, dbo.WEB_TAG_REVIEW.Total_released, 
                      COUNT(dbo.q_Fish_Tag_Recovery_Simple.TAG_ID) * 1.0 / dbo.WEB_TAG_REVIEW.Total_released * 1.0 * 100.0 AS rate, 
                      ...
                      ON dbo.q_Fish_Tag_Recovery_Simple.TAG_NUMBER = dbo.q_Fish_Tag_Release_Simple.TAG_NUMBER AND 
                      dbo.q_Fish_Tag_Recovery_Simple.EVENT_NUMBER = dbo.q_Fish_Tag_Release_Simple.EVENT_NUMBER INNER JOIN
                      dbo.WEB_TAG_REVIEW 
                      ON dbo.q_Fish_Tag_Release_Simple.rel_year = dbo.WEB_TAG_REVIEW.[Release year]
                      group by dbo.q_Fish_Tag_Release_Simple.rel_year, ISNULL(dbo.q_Fish_Tag_Recovery_Simple.rec_year, 0), dbo.WEB_TAG_REVIEW.Total_released, 
                      dbo.q_Fish_Tag_Recovery_Simple.rec_year - dbo.q_Fish_Tag_Release_Simple.rel_year
                      having(dbo.q_Fish_Tag_Release_Simple.rel_year > 1990) AND (ISNULL(dbo.q_Fish_Tag_Recovery_Simple.rec_year, 0) <> 0)
                      order by dbo.q_Fish_Tag_Release_Simple.rel_year, rec_year"
...
```{r figure19, fig.cap='(ref:figure19)', results='asis', out.width = "400px",out.height = "666px", fig.align = "center"}
